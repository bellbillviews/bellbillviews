...
import { Play, Pause, Volume2, VolumeX, Radio, Loader2, Mic2, Music } from "lucide-react";
    ...
    return (
      <div className={cn("relative max-w-md mx-auto", className)}>
        ...
        <div className="relative rounded-3xl overflow-hidden">
          ...
          {/* Glass panel */}
          <div className="relative bg-card/30 backdrop-blur-2xl border border-border/50 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="flex justify-center mb-6">
              <div className={cn(
                ...
                <div className={cn(
                  ...
                  isPlaying
                    ? "border-primary/60 animate-[spin_8s_linear_infinite]"
                    : "border-border/40"
                )} style={{
                  borderStyle: "dashed",
                  borderSpacing: "4px",
                ...
                {liveOnAir?.presenterImage && isPlaying ? (
                  <img
                    ...
                    className="relative w-20 h-20 rounded-full object-cover border-2 border-primary/40"
                  />
                ) : (
                  <Radio className={cn(
                    "relative w-12 h-12 transition-colors duration-500",
            ...
            <div className="flex justify-center mb-6">
              <Button
                ...
                size="lg"
                className={cn(
                  "w-20 h-20 rounded-full transition-all duration-500 border-0",
                  isPlaying
            ...
            <div className="flex items-center gap-4 px-4 py-3 bg-card/30 backdrop-blur-lg rounded-2xl border border-border/30">
              <button
                onClick={toggleMute}
      ...
      <div className="relative bg-card/30 backdrop-blur-2xl border border-border/40 rounded-2xl p-4 flex items-center gap-4 shadow-lg">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground truncate">
            {isPlaying
              ? (liveOnAir?.presenterName ? `🎙 ${liveOnAir.presenterName}` : "Now Playing")
              : "Click to listen"}
          </p>
        </div>
