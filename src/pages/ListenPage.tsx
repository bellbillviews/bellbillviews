...
export default function ListenPage() {
  ...
  const shareLinks = [
    { name: "WhatsApp", icon: MessageCircle, href: `https://wa.me/?text=${encodeURIComponent(shareText + " " + shareUrl)}`, color: "hover:bg-green-500/20 hover:text-green-500" },
        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          <div className="max-w-2xl mx-auto space-y-8">
            <div className="text-center animate-fade-in">
              <p className="text-sm text-primary font-medium uppercase tracking-wider mb-4">Welcome to</p>
