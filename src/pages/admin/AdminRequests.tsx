...
<html>
<head>
  <title>Bellbill Views - Listener Requests</title>
  <style>
    ...
    .header {
      text-align: center;
      border-bottom: 3px solid #5435ac;
      padding-bottom: 20px;
      margin-bottom: 30px;
    }
    .header h1 {
...
<body>
  ...
  <div class="stats">
    ...
    <div class="stat">
      <div class="stat-value">${requests.length - unreadCount}</div>
    ...
    <div class="request">
      <div class="request-header">
        ...
        <div class="request-date">
          ${format(new Date(req.created_at), "EEEE, MMMM d, yyyy")}<br/>
  ...
  <div class="footer">
    <p>Bellbill Views &copy; ${new Date().getFullYear()} - All Rights Reserved</p>
        ...
        <Card>
          <CardContent className="p-0">
            {isLoading ? (
              ...
              <div className="p-8 text-center text-muted-foreground">
                No listener requests yet. They will appear here when listeners
                submit requests from the Listen page.
              </div>
            ) : (
              <Table>
                <TableHeader>
                ...
                <TableBody>
                  {requests.map((request) => (
                    <TableRow
                      key={request.id}
                      className={!request.is_read ? "bg-primary/5" : ""}
                    >
                      <TableCell>
                        {request.is_read ? (
